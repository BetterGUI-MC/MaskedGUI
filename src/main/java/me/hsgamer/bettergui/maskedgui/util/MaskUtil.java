...
public final class MaskUtil {
    ...
    public static List<WrappedButton> createButtons(WrappedMask wrappedMask, Map<String, Object> buttonMap, String prefix, boolean initButton) {
        List<WrappedButton> buttons = new ArrayList<>();
    ...
    public static List<WrappedButton> createButtons(WrappedMask wrappedMask, Map<String, Object> buttonMap, boolean initButton) {
        return createButtons(wrappedMask, buttonMap, wrappedMask.getName() + "_button_", initButton);
    }

    public static List<WrappedButton> createButtons(WrappedMask wrappedMask, Map<String, Object> buttonMap) {
